    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 position-relative">
                <p class="text-left"><a href="./fourth-step.php" class="text-dark"><i class="bi bi-arrow-left pr-2"></i>
                        Back</a>
                </p>
                <div class="fifth-payrimid">
                    <div class="pyramid__shape">
                        <div class="pyramid__steps flex-column">
                            <p class="my-2">Level 1</p>
                            <p class="font-weight-normal"><a class="develop text-theme-primary">You are on this Step</a></p>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="parimid-greets text-left">
                    ...
                    <p class="text-black font-weight-normal"><strong>Level 4</strong> is Completed and You can Now
                        Develop 5th Level accordingly
                        by step.</p>
                ...
                <div class="pyrimid-flow" style="display: none;">
                    <form action="./step-completed.php" method="POST">
