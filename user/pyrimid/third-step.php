    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 position-relative">
                <p class="text-left"><a href="./second-step.php" class="text-dark"><i class="bi bi-arrow-left pr-2"></i>
                        Back</a>
                </p>
                <div class="third-payrimid">
                    <div class="pyramid__shape">
                        ...
                        <div class="pyramid__steps flex-column">
                            ...
                            <button class="develop bg-theme-primary border-0 text-white rounded-pill py-2 px-4 mt-2"
                                id="develop"><i class="bi bi-plus-circle px-2"></i> Develop 2nd Level</button>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="parimid-greets text-left">
                    ...
                    <p class="text-black font-weight-normal"><strong>Level 2</strong> is Completed and You can Now
                        Develop 3rd Level accordingly
                        by step.</p>
                ...
                <div class="pyrimid-flow" style="display: none;">
                    <form action="./fourth-step.php" method="POST">
