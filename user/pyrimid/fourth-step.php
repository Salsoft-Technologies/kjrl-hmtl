    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 position-relative">
                <p class="text-left"><a href="./third-step.php" class="text-dark"><i class="bi bi-arrow-left pr-2"></i>
                        Back</a>
                </p>
                <div class="fourth-payrimid">
            ...
            <div class="col-md-6">
                ...
                <div class="parimid-greets text-left">
                    ...
                    <p class="text-black font-weight-normal"><strong>Level 3</strong> is Completed and You can Now
                        Develop 4th Level accordingly
                        by step.</p>
                ...
                <div class="pyrimid-flow" style="display: none;">
                    <form action="./fifth-step.php" method="POST">
