    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 position-relative">
                <p class="text-left"><a href="./fifth-step.php" class="text-dark"><i class="bi bi-arrow-left pr-2"></i>
                        Back</a>
                </p>
            ...
            <div class="col-md-6">
                ...
                <div class="parimid-greets text-left">
                    ...
                    <p class="text-black font-weight-normal"><strong>All Levels</strong> are Completed and Go to <span
                            class="text-theme-primary font-weight-bold">Pyramid Logs</span></p>
                    <div class="d-flex justify-content-start mt-5">
                        <a href="#" class="text-theme-primary">Back to Home</a>
                    </div>
                </div>
                <div class="pyrimid-flow" style="display: none;">
                    <form action="./add-payrimid.php" method="POST">
                        <div class="pyrimid-form">
                            ...
                            <div class="action-btn gap-15">
                                <button class="bg-light py-2 rounded-pill text-theme-primary border-0 proceedButton"
                                ...
                                <button class="bg-theme-primary py-2 rounded-pill text-light border cancelButton"
...
<div class="modalBtn d-none">
    <button data-toggle="modal" data-target="#pyrimid">abc</button>
</div>
<?php
include './popup.php';
