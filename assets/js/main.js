jQuery(window).scroll(function (event) {
    ...
    if (scroll > 200) {
        jQuery('.user-header').addClass('position-relative');
        jQuery('.user-header').removeClass('position-fixed');
    } else {
        jQuery('.user-header').removeClass('position-relative');
        jQuery('.user-header').addClass('position-fixed');
    }
});
