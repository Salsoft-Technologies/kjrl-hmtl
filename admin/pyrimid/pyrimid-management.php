                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>mm/dd/yyyy</td>
                                <td>6</td>
                                <td class="text-uppercase goldenColor">pending</td>
                                <td>Free</td>
                                <td class="dropdown">
                            ...
                            <tr>
                                ...
                                <td>mm/dd/yyyy</td>
                                <td>6</td>
                                <td class="text-uppercase greenColor">DELIVERED</td>
                                <td>Free</td>
                                <td class="dropdown">
                                    <button id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"
                                        class="border-0 bg-transparent"><i
                            ...
                            <tr>
                                ...
                                <td>mm/dd/yyyy</td>
                                <td>6</td>
                                <td class="text-uppercase blueColor">INPROCESS</td>
                                <td>Free</td>
                                <td class="dropdown">
                                    <button id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"
                                        class="border-0 bg-transparent"><i
                            ...
                            <tr>
                                ...
                                <td>mm/dd/yyyy</td>
                                <td>6</td>
                                <td class="text-uppercase text-danger">rEFUNDED</td>
                                <td>Free</td>
                                <td class="dropdown">
                                    <button id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="false"
                                        class="border-0 bg-transparent"><i
